            ...
            <div className="mt-3 space-y-3">
              {unitListings.map((l) => (
                <Link
                  ...
                  className="roomly-card-in roomly-tilt flex items-center gap-3 rounded-2xl border border-zinc-200 bg-white/80 p-3 backdrop-blur hover:border-violet-300 active:scale-[0.98] dark:border-zinc-800 dark:bg-zinc-900/80 dark:hover:border-violet-700"
                >
